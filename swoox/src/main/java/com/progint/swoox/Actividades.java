...
public class Actividades extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url_hoy = "http://www.swoox.com.mx/app/sql_actividades_del_dia.php?usuario=" + sharedPrefs.getString("idusuario", "NULL")
                + "&fecha=" + dfsql.format(c.getTime());

        url_anteriores = "http://www.swoox.com.mx/app/sql_actividades_pasadas.php?usuario=" + sharedPrefs.getString("idusuario", "NULL")
                + "&fecha=" + dfsql.format(c.getTime());

        url_proximos = "http://www.swoox.com.mx/app/sql_actividades_proximas.php?usuario=" + sharedPrefs.getString("idusuario", "NULL")
                + "&fecha=" + dfsql.format(c.getTime());
    ...
    private void setData(LinkedList<HashMap<String, String>> data){
                ...
                MySimpleAdapter mAdapter = new MySimpleAdapter(Actividades.this, data, R.layout.list_activdades,
           ...
           image.setImageResource(idimagen);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Intent i = new Intent(Actividades.this, Seguimiento.class);
